...
export function Dashboard() {
  ...
  return <main className="main-content">
    ...
    <div className="content-grid">
      ...
      <section className="panel projects-panel"><div className="panel-header"><div><span>Em movimento</span><h3>Projetos ativos</h3></div><Link href="/projects">Abrir workspaces</Link></div><div className="empty-state compact"><Sparkles size={28}/><strong>{data.activeProjects} projetos cadastrados</strong><p>O progresso é atualizado conforme as tarefas são concluídas.</p></div></section>
