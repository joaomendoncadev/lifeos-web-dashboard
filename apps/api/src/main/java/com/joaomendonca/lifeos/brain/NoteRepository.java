...
public interface NoteRepository extends JpaRepository<NoteEntity, UUID> {
  @EntityGraph(attributePaths = {"area", "workspace", "tags"})
  ...
  @EntityGraph(attributePaths = {"area", "workspace", "tags"}) Optional<NoteEntity> findOneById(UUID id);
  List<NoteEntity> findAllByWorkspaceIdAndArchivedFalseOrderByUpdatedAtDesc(UUID workspaceId);
